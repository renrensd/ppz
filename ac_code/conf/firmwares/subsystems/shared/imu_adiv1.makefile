...
IMU_ADIV1_SRCS   += peripherals/adxl350_spi.c
IMU_ADIV1_SRCS   += peripherals/adxrs453_spi.c
IMU_ADIV1_SRCS   += peripherals/hmc58xx.c

include $(CFG_SHARED)/spi_master.makefile

IMU_ADIV1_CFLAGS += -DADIV1_ACCEL_SPI_SLAVE_IDX=SPI_SLAVE3
IMU_ADIV1_CFLAGS += -DADIV1_GYRO_X_SPI_SLAVE_IDX=SPI_SLAVE0
IMU_ADIV1_CFLAGS += -DADIV1_GYRO_Y_SPI_SLAVE_IDX=SPI_SLAVE1
...
IMU_ADIV1_CFLAGS += -DUSE_SPI_SLAVE0
