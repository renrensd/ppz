...
$(TARGET).CFLAGS += -DPERIODIC_TELEMETRY=1
$(TARGET).CFLAGS += -DDOWNLINK=1 -DDOWNLINK_DEVICE=$(XBEE_MODEM_PORT_LOWER) -DXBEE_UART=$(XBEE_MODEM_PORT_LOWER)
...
$(TARGET).srcs += subsystems/datalink/xbee.c subsystems/datalink/downlink_xbee_periodic.c