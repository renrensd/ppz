...
IMU_MPU9250_SPI_DEV ?= spi1
IMU_MPU9250_SPI_SLAVE_IDX ?= SPI_SLAVE3
IMU2_MPU9250_SPI_SLAVE_IDX ?= SPI_SLAVE0
endif
...
IMU_MPU9250_CFLAGS += -DUSE_$(IMU_MPU9250_SPI_DEV_UPPER)=1

IMU_MPU9250_CFLAGS += -DIMU_MPU9250_SPI_SLAVE_IDX=$(IMU_MPU9250_SPI_SLAVE_IDX)
IMU_MPU9250_CFLAGS += -DIMU2_MPU9250_SPI_SLAVE_IDX=$(IMU2_MPU9250_SPI_SLAVE_IDX)

IMU_MPU9250_CFLAGS += -DUSE_$(IMU_MPU9250_SPI_SLAVE_IDX)=1
IMU_MPU9250_CFLAGS += -DUSE_$(IMU2_MPU9250_SPI_SLAVE_IDX)=1
