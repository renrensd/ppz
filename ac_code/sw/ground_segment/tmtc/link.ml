  ...
  let send = fun ?ac_id device rf_data ->
    ...
    let frame_data =
      if !Xbee.mode868 then
        ...
        (*Xbee.api_tx64 ~frame_id (Int64.of_int 0x0013A20040fba080) rf_data*) (*test_board2*)
        (*Xbee.api_tx64 ~frame_id (Int64.of_int 0x0013A200414E7E91) rf_data*) (*test_board*)
        ...
        (*Xbee.api_tx64 ~frame_id (Int64.of_int 0x0013A200414F0CBF) rf_data*) (*no6*)
        Xbee.api_tx64 ~frame_id (Int64.of_int 0x0013A200414F1F90) rf_data (*no10*)
        (*Xbee.api_tx64 ~frame_id (Int64.of_int 0x0013A200414F0D54) rf_data*) (*no10*)
