...
#define INTEGRATOR_BOUND 100000
  ...
  /* bound the result */
#if 0
  if(stabilization_cmd[COMMAND_THRUST]< 5500)   //add thrust limit
  {
  	BoundAbs(stabilization_cmd[COMMAND_ROLL], 3000);
  	BoundAbs(stabilization_cmd[COMMAND_PITCH], 3000);
  	BoundAbs(stabilization_cmd[COMMAND_YAW], 3000);
  }
#endif
