...
#define infrared_i2cDownlink() {xbee_tx_header(XBEE_NACK,XBEE_ADDR_PC);DOWNLINK_SEND_DEBUG_IR_I2C(DefaultChannel, DefaultDevice, &ir_i2c.ir1, &ir_i2c.ir2, &ir_i2c.ir3)}
