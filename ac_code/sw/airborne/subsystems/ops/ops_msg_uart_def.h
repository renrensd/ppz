...
#define OPS_FLOWMETER_CALI_ID 0x0401
#define OPS_FLOW_CALI_ID 0X0501
...
enum OPS_CALI_FLOWMETER_PARAM
{
	FLOWMETER_CALI_START = 0X10,
	FLOWMETER_CALI_START_RES,	//0x11
	FLOWMETER_CALI_NO1,			//0x12
	FLOWMETER_CALI_NO1_RES,		//0x13
	FLOWMETER_CALI_NO2,			//0x14
	FLOWMETER_CALI_NO2_RES,		//0x15
	FLOWMETER_CALI_NO3,			//0x16
	FLOWMETER_CALI_NO3_RES,		//0x17
	FLOWMETER_CALI_NO4,			//0x18
	FLOWMETER_CALI_NO4_RES,		//0x19
	FLOWMETER_CALI_END,			//0x1a
	FLOWMETER_CALI_END_RES		//0x1b
};
