...
void bm_init(void)////test vo   change
{
	...
	bat_info.bq7694.initialized = FALSE;
	bat_info.bq34z.initialized = FALSE;
	bat_info.bq7694.data_available = FALSE;
	bat_info.bq34z.data_available = FALSE;
	bat_info.wdg_cnt = 0;
...
/*****************************************************************************
*  Name        : bat_periodic
*  Description : frequency is 120Hz,time is 8ms.
*  Parameter   : void
*  Returns     : None
*****************************************************************************/
...
{
	bat_info.wdg_cnt++;
	if(bat_info.wdg_cnt > BAT_INFO_WDG_CNT)
	{
		bm_init();
	}
	...
	if(bat_info.bq7694.data_available == TRUE)
	{
		if(bat_info.bq34z.data_available == TRUE)
		{
			bat_info.wdg_cnt = 0;
			bat_info.bq34z.data_available = FALSE;
			bat_info.bq7694.data_available = FALSE;
		...
		{
			RunOnceEvery(60, bq34z_periodic(&bat_info.bq34z) );
		}
	}
	else
	{
